    ...
    async fetch(request, env, ctx) {
      ...
      try {
          ...
          if (path === "/api/login" && request.method === "POST") {
              ...
              if (body.pass === "1234") return new Response(JSON.stringify({ success: true }), { headers: corsHeaders });
          ...
          if (path === "/api/deposit" && request.method === "POST") {
              ...
              // LOGIC: Use 4 digits from ID + 1 random digit
              const id = res.id;
      ...
      return new Response("API Ready v85.4", { headers: corsHeaders });
    },
