...
const CONFIG = {
  ...
  ALLOWED_ORIGIN: "https://v90-crm-test-web.pages.dev",
...
function rewardFlex(name, points, imgUrl, origin) {
  ...
  let finalImgUrl = (imgUrl || "https://v90-crm-test-web.pages.dev/app_icon.png");
  if (finalImgUrl.startsWith("/")) finalImgUrl = origin + finalImgUrl;
  finalImgUrl = finalImgUrl.replace("http://", "https://");

  const finalUri = origin.replace("http://", "https://");

  return {
    type: "flex", 
    altText: `ของรางวัล: ${name || 'Reward'}`,
    contents: {
      type: "bubble",
      hero: { 
        type: "image", 
      ...
      body: {
        ...
        layout: "vertical", 
        contents: [
          { type: "text", text: name || "ของรางวัล", weight: "bold", size: "xl", wrap: true },
          {
            type: "box", 
            layout: "baseline", 
            margin: "md", 
            contents: [
              { type: "text", text: "ใช้แต้มเพียง", size: "sm", color: "#999999", flex: 0 },
              { type: "text", text: `${points || 0} PTS`, size: "sm", color: "#f5a623", weight: "bold", margin: "md" }
            ]
          }
        ]
      },
...
function usedCouponFlex(userName, rewardName, timeStr) {
  return {
    type: "flex",
    altText: `🎫 คูปองถูกใช้งานแล้ว: ${rewardName}`,
    contents: {
      type: "bubble",
      size: "mega",
      body: {
        ...
        contents: [
          { type: "text", text: "🎫 คูปองถูกใช้งานแล้ว", weight: "bold", color: "#EAB308", size: "sm" },
          {
            type: "box",
            layout: "vertical",
            margin: "lg",
            ...
            contents: [
              {
                ...
                contents: [
                  ...
                  { type: "text", text: userName || "ลูกค้า", wrap: true, color: "#ffffff", size: "xs", flex: 5, weight: "bold" }
                ]
              },
              {
                type: "box",
                ...
                spacing: "sm",
                contents: [
                  { type: "text", text: "รายการ:", color: "#aaaaaa", size: "xs", flex: 2 },
                  { type: "text", text: rewardName || "ของรางวัล", wrap: true, color: "#ffffff", size: "xs", flex: 5, weight: "bold" }
                ]
              },
              {
                type: "box",
                ...
                spacing: "sm",
                contents: [
                  { type: "text", text: "วัน/เวลา:", color: "#aaaaaa", size: "xs", flex: 2 },
                  { type: "text", text: timeStr || "-", wrap: true, color: "#ffffff", size: "xs", flex: 5, weight: "bold" }
                ]
              }
            ]
          },
          ...
          {
            type: "text",
            text: "ข้อมูลถูกบันทึกและลบออกจากฐานข้อมูลแล้วเพื่อประหยัดพื้นที่ค่ะ",
            color: "#666666",
            size: "xxs",
            align: "center",
            margin: "md"
