...
const CONFIG = {
  ...
  ALLOWED_ORIGIN: "https://velvetbangsaen.pages.dev",
  LINE_OA_TOKEN: "P5hlP9RFQB2OcEpXMq6VxglChoZirxZN7slvffSq2aGI9Mh0ULO/2h+n45k6JVrDv54rNZ7Yh6ysO9NQ15v3rwLPkewVkHnreuQwaqlda4k4MNPzqufEOOv1kozhZ6+NBttg7tA6NPDYgpdsWPk2sQdB04t89/1O/w1cDnyilFU="
};
            ...
            contents: [
              {
                ...
                action: {
                  ...
                  uri: "https://liff.line.me/2008750442-3EUrznNV"
                }
              }
            ]
          }
    ...
    try {
      ...
      if (p === "/api/buy-ticket" && request.method === "POST") {
        ...
        try {
          ...
          const thunderKey = "5c73b529-7fbe-456a-b7f1-adcce1c4aedc";
